...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        //fix
        UIPanGestureRecognizer *_centerPanGestureRecognizer = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(movePanel:)];
        [_centerPanGestureRecognizer setMinimumNumberOfTouches:1];
        [_centerPanGestureRecognizer setMaximumNumberOfTouches:1];
        [self addGestureRecognizer:_centerPanGestureRecognizer];
	}
	return self;
}
...
- (void)layoutSubviews {
    ...
    CGSize labelSize = [label.text sizeWithAttributes:@{NSAttachmentAttributeName: [UIFont systemFontOfSize:label.font.pointSize]}];
    ...
    CGSize detailsLabelSize = [detailsLabel.text sizeWithAttributes:@{NSAttachmentAttributeName: [UIFont systemFontOfSize:detailsLabel.font.pointSize]}];
