...
#define kCBToastCornerRadius    10.0
...
//        CGSize maximumLabelSize = CGSizeMake(kCBToastMaxWidth, 9999);
        ...
        CGSize expectedLabelSize = [toast.text sizeWithAttributes:@{NSFontAttributeName: [UIFont systemFontOfSize:toast.font.pointSize]}];
        
        
//        [toast.text sizeWithFont:toast.font
...
//                                              lineBreakMode:toast.lineBreakMode];
        ...
        toast.center = CGPointMake(windowFrame.size.width/2, yOffset);
